...
#'   \item mob_mat: A list with each element containing mobility data for 6 hour intervals, so mob_mat[[(i-1)*4+j]] correspond to day i, period j on that day. Each element in the list is a data.table with three columns, the two first giving regions from and to the last giving numbers of individuals that are moved.
